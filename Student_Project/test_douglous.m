%% Test Douglas?eucker algorithm 
% The Ramer?ouglas?eucker algorithm (RDP) is an algorithm for reducing 
...
% under the names Douglas?eucker algorithm, iterative end-point fit 
